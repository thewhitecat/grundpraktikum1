...
def test_datenlesen():
    ...
    data = Praktikum.lese_lab_datei('lab/Thermo_Rauschmessung.lab')
...
def test_lineare_regression():
    ...
    a,ea,b,eb,chiq,corr = \
        Praktikum.lineare_regression(x,y,ey)
...
def test_fourier():
    ...
    freq,amp = Praktikum.fourier(t,y)
    freq_fft,amp_fft = Praktikum.fourier_fft(t,y)
    ...
    fpeak = Praktikum.peakfinder_schwerpunkt(freq,amp)
    fpeak_fft = Praktikum.peakfinder_schwerpunkt(freq_fft,amp_fft)
...
def test_exp_einhuellende():
    ...
    A0,sigmaA0,deltaF,sigmaDelta = Praktikum.exp_einhuellende(t,y,ey)
...
def test_gew_mittel():
    ...
    xm,sx = Praktikum.gewichtetes_mittel(y,ey)
