...
Bei jeweils 0C und 100C wurde eine Rauschmessung der Temperatur durchgeführt. Die Ergebnisse sind in folgender Tabelle aufgelistet:
\begin{center}
\begin{tabular}{|c|c|}
\hline 
...
\begin{center}
Grafik: Ausgleichsgerade bei der Kalibration(VersuchA)\\
\end{center}
...
Aus diesen Ergebnissen wird nun eine Ausgleichsgerade bestimmt. (vgl. \ref{fig:KalibrationB}
...
Bei entsprechender Transformation der Messwerte (erfolgt durch direkte Aufzeichnung mittels CASSY und der Funktion \glqq Größe definieren \grqq) ist bereits deutlich der zumindest lokal gültige lineare Zusammenhang erkennbar.%hier verweis einfügen

%hier Rohdaten

Für den markierten Bereich in der transformierten Darstellung ist die lokale Anpassung exemplarisch in Abb. %hier ref
durchgeführt worden.\\
Weitere Anpassungen auf symmetrischen Intervallen bestimmte (reziproke) Temperaturwerte wurden durchgeführt. Die Ergebnisse finden sich in Tab. %hier ref

%hier exemplarischen fit
