...
Der Versuch wurde von zwei Teilgruppen unabhängig voneinander durchgeführt. Im folgenden werden diese mit "Versuch A" und "Versuch B" bezeichnet und einzeln ausgewertet 
...
\begin{equation}
\sigma_{m} = m\cdot \sqrt{\left( \dfrac{\sigma_{T_{siedend}}\cdot 99.72}{(T_{siedend}-T_{Eis}^{2}}\right) ^{2}+\left( \dfrac{\sigma_{T_{Eis}}\cdot 99.72}{T_{siedend}-T_{Eis}}\right) ^{2}} = 0.0001
\end{equation}
...
\begin{equation}
\sigma_{b} = \sqrt{\left( \dfrac{\sigma_{m}}{m}\right) ^{2}+\left( \dfrac{\sigma_{T_{siedend}}}{T_{siedend}}\right) ^{2}} = 0.0003C
\end{equation}
...
\begin{equation}
\sigma_{T}=\sqrt{\left(m\cdot T_{gemessen}\cdot \sqrt{ \left(\dfrac{\sigma_m}{m}\right)^{2}+\left(\dfrac{\sigma_T}{T}\right)^{2}}\right)^{2}+\sigma_{b}^{2}}=0.13
\end{equation}
...
\subsubsection{Kalibrierung des Temperatursensors}
Bei jeweils 0C und 100C wurde eine Rauschmessung der Temperatur durchgeführt. Da am Versuchstag nicht Normaldruck, sondern ein Druck von 1005hPa geherrscht hat, muss die Siedetemperatur noch auf 99.72C korrigiert werden. Die Ergebnisse sind in Tabelle \ref{tab:KaliB} aufgeführt. Die angegebenen Fehler sind die Fehler des Mittelwertes.
...
\begin{equation}
\sigma_{b} = b\cdot \sqrt{\left( \dfrac{\sigma_{m}}{m}\right) ^{2}+\left( \dfrac{\sigma_{T_{siedend}}}{T_{siedend}}\right) ^{2}} = 0.0001C
\end{equation}
...
Aus der Fehlerfortpflanzung folgt der Fehler auf die Temperatur:
\begin{equation}
\sigma_{T}=\sqrt{\left(m\cdot T_{gemessen}\cdot \sqrt{ \left( \dfrac{\sigma_m}{m}\right) ^{2}+\left( \dfrac{\sigma_T}{T}\right) ^{2}}\right)^{2}+\sigma_{b}^{2}}=0.05
\end{equation}
