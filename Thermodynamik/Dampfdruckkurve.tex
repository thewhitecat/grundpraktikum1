...
\begin{equation}
T_{erwartet}=1.028*T_{gemessen}-2.1801
\end{equation}
\subsection{Versuch B}
\subsubsection{Rauschmessung}
um die Ungenauigkeit der Messgeräte zu bestimmen, wurde eine Rauschmessung durchgeführt.
\begin{tabular}{|c|c|c|c|}
\hline 
 & Mittelwert & Fehler(stat.) & Fehler(sys.)\\ 
\hline 
Temperatur & 22.987 & 0.035 & \\ 
\hline 
Druck & 1021.04 & 0.37 & 0.51\\ 
\hline 
\end{tabular} 
\subsubsection{Kalibrierung des Temperatursensors}
...
Damit können die wirklichen Temperaturen berechnet werden:
\begin{equation}
T_{erwartet}=1.013*T_{gemessen}-0.5304
\end{equation}
