...
Bei jeweils 0C und 100C wurde eine Rauschmessung der Temperatur durchgeführt. Die Ergebnisse sind in \ref{tab:KalA} aufgelistet
\begin{table}
\begin{center}
\begin{tabular}{|c|c|}
\hline 
...
\end{center}
\label{tab:KalA}
\caption{Temperaturmessungen bei 0C und 100C}
\end{table}

\includegraphics[width=\linewidth]{Bilder/KalibrationA}\\
\begin{center}
Grafik: Ausgleisgerade bei der Kalibration(VersuchA)\\
\end{center}
