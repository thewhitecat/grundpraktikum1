...
plt.figure(1)
plt.hist(druck_a,bins=bins_a_druck,normed=True,align='left')
#plt.xticks()
...
plt.figure(2)
plt.hist(temp_a,bins=bins_a_temp,normed=True,align='left')
...
plt.figure(3)
plt.hist(druck_b,3,normed=True,align='left')
...
plt.figure(4)
plt.hist(temp_b,bins=bins_b_temp,normed=True,align='left')
