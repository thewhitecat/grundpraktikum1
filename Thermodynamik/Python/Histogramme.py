...
x=np.linspace(993.5,994.5,1000)
bins_a_druck=[993.75-2*0.75,993,993.75,994.5,995.25]
plt.figure(1)
plt.hist(druck_a,bins=bins_a_druck,normed=True,align='left',rwidth=0.9)
#plt.xticks()
plt.plot(x,gauss(x,m_a_druck,s_a_druck))
...
plt.figure(2)
plt.hist(temp_a,bins=bins_a_temp,normed=True,align='left',rwidth=0.9)
plt.plot(x,gauss(x,m_a_temp,s_a_temp))
...
x=np.linspace(1019,1022.5,1000)
bins_b_druck=[1020-2*0.75,1020-0.75,1020,1020.75,1021.5,1022.25]
plt.figure(3)
plt.hist(druck_b,3,normed=True,align='left',rwidth=0.9)
plt.plot(x,gauss(x,m_b_druck,s_b_druck))
plt.xlabel('Druck [hPa]')
plt.ylabel('#')
...
plt.figure(4)
plt.hist(temp_b,bins=bins_b_temp,normed=True,align='left',rwidth=0.9)
plt.plot(x,gauss(x,m_b_temp,s_b_temp))
plt.xlabel('Temperatur [C]')
plt.ylabel('#')
