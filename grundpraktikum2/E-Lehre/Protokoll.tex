...
Die Frequenzbestimmung wird an den verschobenen Kurven erneut vorgenommen. Die Abstände zwischen Frequenz der unveränderten Kurve und den Frequenzen der verschobenen Kurven stellen den systematischen Fehler dar. Durch die Herstellerangabe von $\sigma_{U_i} = 0,01 \cdot U_i$ für die Spannung wird sich dieser aufgrund des Kurvenverlaufs in einen gegebenenfalls asymmetrischen, noch größeren relativen Fehler auf die Frequenz fortpflanzen. Die Bestimmung an den Spannungsverläufen von Hoch- und Tiefpass wird deswegen mit erwartungsgemäß großem systematischen Fehler erfolgen.
