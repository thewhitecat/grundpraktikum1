...
Die Ergebnisse der Dämpfung werden in einem gewichteten Mittelwert zusammengefasst zu $\delta=(0.28 \pm 0.01)1/ms$.
...
\begin{equation}
R_{ap}=2\cdot \sqrt{\frac{L}{C}}=2\cdot \sqrt{\frac{35.8mH}{4.7\mu F}}=175.6\Omega
\end{equation}
